      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 border-t bg-white p-4 space-y-3">
          <div className="grid grid-cols-2 gap-2 mt-1">
            <Link href="/register" className="bg-orange-500 text-center font-semibold text-white py-2 rounded-lg hover:bg-orange-600 transition-colors">
              Sign Up
            </Link>
            <Link href="/login" className="bg-green-500 text-center font-semibold text-white py-2 rounded-lg hover:bg-green-600 transition-colors">
              Log In
            </Link>
          </div>
        </div>
